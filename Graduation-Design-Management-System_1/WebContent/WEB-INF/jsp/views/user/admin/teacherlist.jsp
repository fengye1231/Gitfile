...
// 	System.out.println(request.getServletContext().getResource("/toteacherlist.action").toString());

// 	ServletContext sc = pageContext.getServletContext();
// 	System.out.println(request.getServletContext().getJspConfigDescriptor());
...
// 	request.getRequestDispatcher("/WEB-INF/jsp/views/user/admin/teacherlists.jsp").forward(request, response);
