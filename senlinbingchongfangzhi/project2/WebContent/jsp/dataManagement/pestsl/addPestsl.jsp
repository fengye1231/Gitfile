...
<div id="main">
    ...
    <form class="form-horizontal" role="form" action="/project2/AddPestsl" method="post" enctype="multipart/form-data" id="form1">
        <div class="control-group">
        	<span id="span1">请输入2个到20个字的名称</span>
				<br/>
            <label class="control-label" for="input01">名称</label>
            <input name="pestslName" type="text" placeholder="名字" class="input-xlarge" id="input01">
        </div>
        <div class="control-group">
        	<span id="span2">请输入2个到20个字的寄主名</span>
				<br/>
            <label class="control-label" for="input01">寄主</label>
            <input name="host" type="text" placeholder="寄主名" class="input-xlarge" id="input02">
        </div>
        <div class="control-group">	
        ...
        <div class="control-group">
            <label class="control-label">幼虫照片</label>
            <input name="fileImg" class="input-file"  id="fileInput1" type="file">
        </div>
        <div class="control-group">
            <label class="control-label">成虫照片</label>
            <input name="fileImg1" class="input-file" id="fileInput2" type="file">
        </div>
        <div class="control-group">
