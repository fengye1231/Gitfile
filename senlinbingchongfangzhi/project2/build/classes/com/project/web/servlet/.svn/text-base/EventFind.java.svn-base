...
/**
 * Servlet implementation class EventFind
 */
@WebServlet("/EventFind")
public class EventFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IClassService servicec=new ClassServiceImpl();
		 ...
		 response.sendRedirect("/project2/jsp/disasterPrevention/event/FindEvent.jsp");
