...
public class EventDaoImpl implements IEventDao{
	...
	public void AddEventBean(EventBean bean) {
		...
		map.put("imgPath", bean.getImgPath());
		map.put("date", bean.getDate());
		map.put("type", bean.getType());
		map.put("phase", bean.getPhase());
		map.put("describe", bean.getDescribe());
		map.put("findPath", bean.getFindPath());
		map.put("area", bean.getArea());
		map.put("lose",bean.getLose());
		map.put("affectArea", bean.getAffectArea());
		map.put("plan", bean.getPlan());
	...
	public void UpdatePhase(int id) {
		String way ="com.project.web.mapper.eventMapper.updateP";
		SqlSession session=MyBatisUtil.getSqlSession(true);
