	...
	<form action="${ctx}/sys/update${actionclass1}.action" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
		...
		<table class="table table-condensed table-hover" width="100%">
			<tbody>
				<tr>
					<td>
						<label for="j_custom_fname<%=labelindex%>" class="control-label x120">姓名：</label>
						<input type="text" name="name" value="${modifybean.name}" id="j_custom_fname<%=labelindex++%>"
				...
				<tr>
					<td>
						<label for="j_custom_sale32143rew4r23" class="control-label x120">性别：</label>
						<select name="gender"  id="j_custom_sale32143rew4r23"
...
<script type="text/javascript">
$("#j_custom_sale32143rew4r23").val("${modifybean.gender}");
</script>