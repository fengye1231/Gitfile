...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}.action" method="post">
        ...
        <div class="bjui-searchBar">
            <label>车次：</label><input type="text" value="" id="${actionclass1}_checi" name="s_checi" class="form-control" size="10">&nbsp;
            <label>失物内容：</label><input type="text" value="" id="${actionclass1}_wuping" name="s_wuping" class="form-control" size="10">&nbsp;
            <label>领取人姓名：</label><input type="text" value="" id="${actionclass1}_name" name="s_name" class="form-control" size="10">&nbsp;
            <label>领取人身份证：</label><input type="text" value="" id="${actionclass1}_idcard" name="s_idcard" class="form-control" size="10">&nbsp;
<!--             <label>:</label> -->
