...
<div class="bjui-pageContent">
	...
	<form action="${ctx}/sys/add${actionclass1}.action" id="j_custom_form" data-toggle="validate"
		...
		<table class="table table-condensed table-hover" width="100%">
			<tbody>
				<tr>
					<td><label for="j_custom_fname<%=labelindex%>" class="control-label x85">类型：</label> <select
						name="type">
				...
				<tr>
					<td><label for="j_custom_fname<%=labelindex%>" class="control-label x85">主题：</label> <input
						type="text" name="title" value="${modifybean.title}" id="j_custom_fname<%=labelindex++%>"
