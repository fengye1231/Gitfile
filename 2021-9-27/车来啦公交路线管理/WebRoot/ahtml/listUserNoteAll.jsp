...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}All.action" method="post">
        ...
        <tbody>
            ...
            <tr data-id="${item.id }">
               ...
               <td>${item.type}</td>
                ...
                <td>
                    <a href="${ctx}/sys/get${actionclass1}All.action?uid=${item.id}" class="btn btn-green" data-toggle="navtab" data-options="{reloadWarn:''}" data-id="baseAdd" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？" data-title="投诉建议详情">查看</a>
