			...
			<tbody>
				<tr>
					<td>
						...
						<select name="bus.id" class="" id="nkl23j423kl4j23klj42l">
				...
				<tr>
					<td>
						...
						<select name="driver.id" class="" id="nkl23j423kl4j23klj42l2">
				...
				<tr>
					<td>
						...
						<select name="line.id" class="" id="nkl23j423kl4j23klj42l3">
...
<script type="text/javascript">
$("#nkl23j423kl4j23klj42l").val("${modifybean.bus.id}");
$("#nkl23j423kl4j23klj42l2").val("${modifybean.driver.id}");
$("#nkl23j423kl4j23klj42l3").val("${modifybean.line.id}");
</script>