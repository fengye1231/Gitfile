...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}.action" method="post">
        ...
        <div class="bjui-searchBar">
            <label>：</label><input type="text" value="" id="${actionclass1}_name" name="s_name" class="form-control" size="10">&nbsp;
<!--             <label>:</label> -->
<!--             <select name="type" data-toggle="selectpicker" id="${actionclass1}_status" name="s_status"> -->
