...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}.action" method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <label>身份证：</label><input type="text" value="" id="${actionclass1}_cardno" name="s_cardno" class="form-control" size="10">&nbsp;
            <label>驾照：</label><input type="text" value="" id="${actionclass1}_driverno" name="s_driverno" class="form-control" size="10">&nbsp;
<!--             <label>:</label> -->
