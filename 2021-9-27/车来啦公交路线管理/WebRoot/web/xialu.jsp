...
<body>
	...
	<div id="header-wrapper">
		<jsp:include page="./menu.jsp"><jsp:param value="line" name="type" />
		</jsp:include>
	</div>
	<!-- Main -->
		...
		<div class="5grid-layout" style="margin-top: 50px">
			<div class="row">
				<div class="3u" style="width: 100%">
					<input type="text" placeholder="输入线路名称" id="startSta" list="pastalist">
					<a class="button blue" onclick="busSearch()">查询</a>
				</div>
	...
	<datalist id="pastalist">
		<c:forEach items="${lineList}" var="fitem">
			<option>${fitem.sid }</option>
		</c:forEach>
	</datalist>
	<!-- Footer -->
