...
public class UserMessage
{
	...
	public String[] read(String countname) throws IOException
	{
        ...
        String []message = new String[8];     //按~拆分 成8个字符串数组，按账号和密码进行信息验证
        while(temp!=null){
	...
	//进行删除账户
//	public void deletecout(String countname)throws IOException
//	{
	...
	public String updatepwd(String countname,String pwd) throws IOException
	{
        ...
        while(temp!=null){
        	...
        	if (message[2].equals(countname))   //找到该账户名
        	{
        		...
        		sb1.append(message[5]+"~\n");
        		sb1.append(message[6]+"~\n");
        		sb1.append(message[7]+"~\n");
        	}
        	else
        	{
        		sb1.append(temp+"\n");
