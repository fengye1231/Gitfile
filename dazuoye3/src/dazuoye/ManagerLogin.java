...
//  ButtonGroup group=null;//声明按钮组
  ...
  JPanel p1,p2,p3,p4,p5,p6,p7,pv,ph,pb,p0;//调节布局的通道
  ...
  public ManagerLogin(){       //负责管理员登录的主窗口
      ...
      group.add(radioBtn01);
      group.add(radioBtn02);
  	   ...
  	   public void actionPerformed(ActionEvent e) {		     		     
  		 ...
  		 if(sID.equals("")||sname.equals(""))
  		 {
    		...
    		if(siden.equals(""))
    		   siden="--";
    		 String ssex=null;
           if(radioBtn01.isSelected()){//选择男女
              ssex=radioBtn01.getText();
           }
           else{
               ssex=radioBtn02.getText();
           }   
