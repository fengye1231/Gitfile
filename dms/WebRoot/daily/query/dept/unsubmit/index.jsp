...
<%
	List<DepartmentVo> departments = DepartmentLoadServiceImpl
			.getInstance().getDepartments();
		...
		<div class="panel-body no-padding-bottom">
			<div class="row">
				<form action="#" method="post" id="form-query"
					...
					<div class="col-sm-6 col-md-3">
						<div class="form-group input-group">
							...
							<input type="text" readonly id="start-date"
								class="form-datetime form-control" data-lte="#end-date" data-maxinterval="0-0-14" 
								data-name="startDate" data-max="today" data-default="today"
					...
					<div class="col-sm-6 col-md-3">
						<div class="form-group input-group">
							...
							<input type="text" readonly id="end-date"
								...
								data-name="endDate" data-default="today" placeholder="请选择"
								required>
						</div>
					</div>
					...
					<div class="col-sm-6 col-md-1">
						<div class="form-group">
							<button type="button" id="warn-btn"
