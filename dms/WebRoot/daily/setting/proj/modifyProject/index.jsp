...
<%@page import="com.neusoft.dms.prj.domain.*"%>
...
Prj prj = (Prj) request.getAttribute("prj");
String startDate = sdf.format(prj.getStartDate());
String endDate = sdf.format(prj.getEndDate());
...
<script>
	var prjStatus = "${prjStatus}";
</script>

<div class="container-fluid">
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			<form action="<%= basePath %>/daily/setting/proj/ProjectServlet?service=updatePrj&prjID=${prj.prjID}" method="post" data-toggle="validator" role="form" 
					...
					<div class="panel-footer">
						<div class="form-group no-margin-bottom">
							<div class="col-sm-3 col-sm-offset-3">
								<a class="btn btn-default btn-block" onclick="history.go(-1)">
									返 回
								</a>
							</div>
							<div class="col-sm-3">
