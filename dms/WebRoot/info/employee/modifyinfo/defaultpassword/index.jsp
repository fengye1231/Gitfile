		...
		<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
			<div class="panel-body">
				<form role="form" class="form-horizontal" data-toggle="validator"
					action="<%= basePath %>info/employee/employee.servlet?service=defaultPassword&username=${username}" method="post">
						...
						<div class="panel-footer">
							<div class="form-group no-margin-bottom">
								<div class="col-sm-3 col-sm-offset-6">
									<button type="button" onclick="window.location.href='../employee/modifyinfo/index.jsp'" class="btn btn-default btn-block">
										取 消 </button>
								</div>
								<div class="col-sm-3">
